...
<!-- Section 1 -->
		...
		<section id="section1">
			...
			<div style="padding-bottom:20px;">
				...
				<p>
	            No código abaixo você encontra as configurações para a criação da tabela de dados do MCTQ em MySQL.
	            </p>
			...
			<div style="padding-bottom:80px">
				...
				<div class="w3-code">
					...
					show_source("../php/mysql-table.txt");
